...
40. Fail : To date, the LCS continues to fail, to inclued property damage. Micro-management of each LCS crew, per LCS session, per unit, is absolutely required to meet minimum LCS contractual obligations. Even then, micro-management is not always well received by the foreign labor crew.
